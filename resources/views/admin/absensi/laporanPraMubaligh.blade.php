...
<section class="content-header">
      <h1>
        Tabel
        <small>Absensi Pra Mubaligh</small>
      </h1>
      <ol class="breadcrumb">
...
<section class="content">
    <form class="" method="get" action="/absenpramubaligh/LaporanPraMubaligh">
    @csrf
        <div class="box">
...
<!-- /.box-body -->
            <div class="box-footer">
                <a href="LaporanPraMubaligh/cetak_pdf/{{$tgl_lapor}}/{{$id_kelas}}" class="btn btn-sm btn-primary" target="_blank"><i class="fa fa-print"></i> CETAK PDF</a>
            </div>
        </div>
