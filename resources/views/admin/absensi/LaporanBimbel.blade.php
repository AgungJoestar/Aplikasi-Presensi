...
<section class="content">
    <form class="" method="get" action="/absenbimbel/LaporanBimbel">
    @csrf
        <div class="box">
...
<!-- /.box-body -->
            <div class="box-footer">
                <a href="LaporanBimbel/cetak_pdf/{{$tgl_lapor}}/{{$id_kelas}}" class="btn btn-sm btn-primary" target="_blank"><i class="fa fa-print"></i> CETAK PDF</a>
            </div>
        </div>
