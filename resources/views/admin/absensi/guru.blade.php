...
<!-- /.box-header -->
            <div class="box-body">
                ...
                <?php $getid[$nomer] = $row->nip; ?>
                    ...
                    <td>{{$row->nip}}</td>
                    <td>{{$row->nama}}</td>
                    <input type="hidden" name="nip[]" value="{{$getid[$nomer]}}">
                    <!-- <td><input type = "checkbox" name = "nis[]" value = "{{$getid[$nomer]}}"/></td> -->
                    <td><input type="radio" name="absen{{$row->nip}}" value="hadir"></td>
                    <td><input type="radio" name="absen{{$row->nip}}" value="sakit"></td>
                    <td><input type="radio" name="absen{{$row->nip}}" value="alfa"></td>
                    <td><input type="radio" name="absen{{$row->nip}}" value="izin"></td>
                    <td><input name="keterangan{{$row->nip}}" type="text" class="form-control" id="keterangan" placeholder="Keterangan"></td>
                <?php $nomer++; ?>
                </tr>
                @endforeach
                </tbody>
