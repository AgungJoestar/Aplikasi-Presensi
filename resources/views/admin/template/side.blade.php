    ...
    <li class="treeview">
        ...
        <li  class="treeview">
            ...
            <ul id="siswa" class="treeview-menu">
                @if(Gate::check('isAdmin')|| Gate::check('isSuper_admin')||Gate::check('isPasca_mubaligh'))
                <li><a href="/absenpascamubaligh"><i class="fa fa-circle-o"></i>Absen Pasca Mubaligh</a></li>
                @endif
                @if(Gate::check('isAdmin')|| Gate::check('isSuper_admin')||Gate::check('isPra_mubaligh'))
                <li><a href="/absenpramubaligh"><i class="fa fa-circle-o"></i>Absen Pra Mubaligh</a></li>
                @endif
                @if(Gate::check('isAdmin')|| Gate::check('isSuper_admin')||Gate::check('isReguler'))
                <li><a href="/absensiswasekolah"><i class="fa fa-circle-o"></i>Absen Sekolah</a></li>
                @endif
                @if(Gate::check('isAdmin')|| Gate::check('isSuper_admin')||Gate::check('isBimbel'))
                <li><a href="/absenbimbel"><i class="fa fa-circle-o"></i>Absen Bimbel</a></li>
                @endif
                <!--@if(Gate::check('isAdmin')|| Gate::check('isSuper_admin')||Gate::check('isPesantren'))
